...
from App.apis.cinema_admin.cinema_address_api import CinemaAddressResource, CinemaAddressesResource
...
from App.apis.cinema_admin.cinema_movie_hall_api import CinemaMovieHallsResource
...
cinema_client_api.add_resource(CinemaMovieHallsResource, '/cinemamoviehalls/')
